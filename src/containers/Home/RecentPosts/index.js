    ...
    <div style={props.style}>
        <Card style={{marginBottom: '20px'}}>
            <div className="postImageWrapper">
                <img src={"https://image.freepik.com/free-vector/hand-drawing-beautiful-young-woman-portrait-fashion-girl-with-coffee-girl-warm-sweater-sketch_357668-26.jpg"} alt=""/>
            </div>
